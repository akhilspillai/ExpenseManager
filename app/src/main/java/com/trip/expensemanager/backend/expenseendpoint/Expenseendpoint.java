 ...
 * on 2015-03-18 at 15:36:43 UTC 
 * Modify at your own risk.
 */

package com.trip.expensemanager.backend.expenseendpoint;
...
public class Expenseendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ExpenseEndpoint {
    ...
    public class RemoveTripExpense extends ExpenseendpointRequest<Void> {
       ...
       * optional parameters, call the {@link RemoveTripExpense#execute()} method to invoke the remote
       * operation. <p> {} must be called to initialize this instance immediately after
  ...
  public class GetExpense extends ExpenseendpointRequest<Expense> {
    ...
    protected GetExpense(java.lang.Long id) {
      super(Expenseendpoint.this, "GET", REST_PATH, null, Expense.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * operation.
   *
   * @param content the {@link com.trip.expensemanager.backend.expenseendpoint.model.Expense}
   * @return the request
   */
  public InsertExpense insertExpense(Expense content) throws java.io.IOException {
    InsertExpense result = new InsertExpense(content);
    initialize(result);
    return result;
  }

  public class InsertExpense extends ExpenseendpointRequest<Expense> {
     ...
     * @since 1.13
     */
    protected InsertExpense(Expense content) {
      super(Expenseendpoint.this, "POST", REST_PATH, content, Expense.class);
    }
  ...
  public class ListExpense extends ExpenseendpointRequest<CollectionResponseExpense> {
    ...
    protected ListExpense() {
      super(Expenseendpoint.this, "GET", REST_PATH, null, CollectionResponseExpense.class);
    }
   ...
   * @return the request
   */
  public UpdateExpense updateExpense(Expense content) throws java.io.IOException {
    UpdateExpense result = new UpdateExpense(content);
    initialize(result);
    return result;
  }

  public class UpdateExpense extends ExpenseendpointRequest<Expense> {
     ...
     * @since 1.13
     */
    protected UpdateExpense(Expense content) {
      super(Expenseendpoint.this, "PUT", REST_PATH, content, Expense.class);
    }
