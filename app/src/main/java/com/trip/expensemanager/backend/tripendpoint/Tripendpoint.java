 ...
 * on 2015-03-18 at 15:37:12 UTC 
 * Modify at your own risk.
 */

package com.trip.expensemanager.backend.tripendpoint;

import com.trip.expensemanager.backend.tripendpoint.model.CollectionResponseTrip;
...
public class Tripendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetTrip extends TripendpointRequest<Trip> {
    ...
    protected GetTrip(java.lang.Long id) {
      super(Tripendpoint.this, "GET", REST_PATH, null, Trip.class);
   ...
   *
   * @param content the {@link com.trip.expensemanager.backend.tripendpoint.model.Trip}
   * @return the request
   */
  public InsertTrip insertTrip(Trip content) throws java.io.IOException {
    InsertTrip result = new InsertTrip(content);
    initialize(result);
    return result;
  }

  public class InsertTrip extends TripendpointRequest<Trip> {
     ...
     * @since 1.13
     */
    protected InsertTrip(Trip content) {
      super(Tripendpoint.this, "POST", REST_PATH, content, Trip.class);
    }
  ...
  public class ListTrip extends TripendpointRequest<CollectionResponseTrip> {
     ...
     */
    protected ListTrip() {
      super(Tripendpoint.this, "GET", REST_PATH, null, CollectionResponseTrip.class);
    }
   ...
   * @return the request
   */
  public UpdateTrip updateTrip(Trip content) throws java.io.IOException {
    UpdateTrip result = new UpdateTrip(content);
    initialize(result);
    return result;
  }

  public class UpdateTrip extends TripendpointRequest<Trip> {
     ...
     * @since 1.13
     */
    protected UpdateTrip(Trip content) {
      super(Tripendpoint.this, "PUT", REST_PATH, content, Trip.class);
    }
