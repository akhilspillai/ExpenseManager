...
package com.trip.expensemanager.backend.distributionendpoint;
...
public class Distributionendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetDistribution extends DistributionendpointRequest<Distribution> {
    ...
    protected GetDistribution(java.lang.Long id) {
      super(Distributionendpoint.this, "GET", REST_PATH, null, Distribution.class);
   ...
   * operation.
   *
   * @param content the {@link com.trip.expensemanager.backend.distributionendpoint.model.Distribution}
   * @return the request
   */
  public InsertDistribution insertDistribution(Distribution content) throws java.io.IOException {
    InsertDistribution result = new InsertDistribution(content);
    initialize(result);
    return result;
  }

  public class InsertDistribution extends DistributionendpointRequest<Distribution> {
     ...
     * @since 1.13
     */
    protected InsertDistribution(Distribution content) {
      super(Distributionendpoint.this, "POST", REST_PATH, content, Distribution.class);
    }
  ...
  public class ListDistribution extends DistributionendpointRequest<CollectionResponseDistribution> {
    ...
    protected ListDistribution() {
      super(Distributionendpoint.this, "GET", REST_PATH, null, CollectionResponseDistribution.class);
    }
   ...
   * @return the request
   */
  public UpdateDistribution updateDistribution(Distribution content) throws java.io.IOException {
    UpdateDistribution result = new UpdateDistribution(content);
    initialize(result);
    return result;
  }

  public class UpdateDistribution extends DistributionendpointRequest<Distribution> {
     ...
     * @since 1.13
     */
    protected UpdateDistribution(Distribution content) {
      super(Distributionendpoint.this, "PUT", REST_PATH, content, Distribution.class);
    }
