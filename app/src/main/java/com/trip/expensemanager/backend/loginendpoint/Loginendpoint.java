...
package com.trip.expensemanager.backend.loginendpoint;
...
public class Loginendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class LogInEndpoint {
     ...
     *
     * @param content the {@link com.trip.expensemanager.backend.loginendpoint.model.LogIn}
     * @return the request
     */
    public MergeLogIn mergeLogIn(LogIn content) throws java.io.IOException {
      MergeLogIn result = new MergeLogIn(content);
      initialize(result);
      return result;
    }

    public class MergeLogIn extends LoginendpointRequest<LogIn> {
       ...
       * @since 1.13
       */
      protected MergeLogIn(LogIn content) {
        super(Loginendpoint.this, "POST", REST_PATH, content, LogIn.class);
      }
  ...
  public class GetLogIn extends LoginendpointRequest<LogIn> {
    ...
    protected GetLogIn(java.lang.Long id) {
      super(Loginendpoint.this, "GET", REST_PATH, null, LogIn.class);
   ...
   * @return the request
   */
  public InsertLogIn insertLogIn(LogIn content) throws java.io.IOException {
    InsertLogIn result = new InsertLogIn(content);
    initialize(result);
    return result;
  }

  public class InsertLogIn extends LoginendpointRequest<LogIn> {
     ...
     * @since 1.13
     */
    protected InsertLogIn(LogIn content) {
      super(Loginendpoint.this, "POST", REST_PATH, content, LogIn.class);
    }
  ...
  public class ListLogIn extends LoginendpointRequest<CollectionResponseLogIn> {
     ...
     */
    protected ListLogIn() {
      super(Loginendpoint.this, "GET", REST_PATH, null, CollectionResponseLogIn.class);
    }
   ...
   * @return the request
   */
  public UpdateLogIn updateLogIn(LogIn content) throws java.io.IOException {
    UpdateLogIn result = new UpdateLogIn(content);
    initialize(result);
    return result;
  }

  public class UpdateLogIn extends LoginendpointRequest<LogIn> {
     ...
     * @since 1.13
     */
    protected UpdateLogIn(LogIn content) {
      super(Loginendpoint.this, "PUT", REST_PATH, content, LogIn.class);
    }
